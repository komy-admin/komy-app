...
/**
 * Modal mémoïsée pour confirmer le service d'articles
 */
export const ServeConfirmModal = memo<ServeConfirmModalProps>(({
  isVisible,
  itemsData,
  onClose,
  onConfirm
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.actionsRow}>
          ...
          >
            <Text style={styles.confirmText}>Confirmer le service</Text>
          </Pressable>
        </View>
      </View>
    </CustomModal>
...
ServeConfirmModal.displayName = 'ServeConfirmModal';
